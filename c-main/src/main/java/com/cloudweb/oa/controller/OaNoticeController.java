...
//            }
    ...
    public void getFile(HttpServletResponse response, @RequestParam(required = true) Long attachId) throws IOException, ErrMsgException {
        OaNoticeAttach oaNoticeAttach = oaNoticeAttachMapper.selectById(attachId);
        fileService.download(response, oaNoticeAttach.getName(), oaNoticeAttach.getVisualPath(), oaNoticeAttach.getDiskName());
    }
}