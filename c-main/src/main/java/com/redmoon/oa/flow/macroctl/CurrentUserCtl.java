...
public class CurrentUserCtl extends AbstractMacroCtl {
    ...
    public String setUserInfo(String fieldName, String value) {
        ...
        sb.append("if (findObj('" + fieldName + "')) {\n");
        sb.append(" findObj('" + fieldName + "').value='" + value + "';\n");
        sb.append("}\n");
        sb.append("if (findObj('" + fieldName + "_show')) {\n");
        sb.append(" findObj('" + fieldName + "_show').innerHTML = '" + value + "';\n");
        sb.append("}\n");
        return sb.toString();
    }
    ...
    public String getHideCtlScript(FormField ff, String formElementId) {
        ...
        str += "\r\nif(findObj('" + ff.getName() + "_realname" + "')!=null){HideCtl('" + ff.getName() + "_realname" + "', '" +
        	ff.getType() +
        	"', '" + ff.getMacroType() + "');}\n";
        return str; 
    }    
