...
import com.cloudweb.oa.service.impl.OaNoticeServiceImpl;
    ...
    public String renderAction(HttpServletRequest request) {
        ...
        switch (myaction) {
            ...
            case ACTION_NOTICE:
                ...
                OaNotice oaNotice = oaNoticeService.getNoticeById(StrUtil.toLong(action, -1));
                if (oaNotice == null) {
                    return "<span style='color:red'>当前通知公告已删除</span>";
                } else {
                    return "<a href='javascript:;' onclick=\"addTab('" + oaNotice.getTitle() + "', '" + request.getContextPath() + "/notice/show.do?id=" + action + "&isShow=1')\">点击查看</a>";
                }
            default: {
                break;
            }
