        ...
        try {
            ...
            if (isGetIdsFromDb) {
                ...
                if ("id".equals(fieldName)) {
                    ...
                    // objs[0] = StrUtil.toLong(fieldValue, -1);
                    objs[0] = fieldValue;
                    // long tSql = System.currentTimeMillis();
                    JdbcTemplate jt = new JdbcTemplate();
                    ResultIterator ri = jt.executeQuery(sql, objs);
                    /*if (Global.getInstance().isDebug()) {
                        DebugUtil.i(FormDAOMgr.class, "jt executeQuery：", "" + ((double)System.currentTimeMillis() - tSql)/1000);
                    }*/
                    while (ri.hasNext()) {
                        ResultRecord rr = ri.next();
                        id = rr.getLong(1);
                    ...
                    /*if (Global.getInstance().isDebug()) {
                        DebugUtil.i(FormDAOMgr.class, "jt getId：", "" + ((double)System.currentTimeMillis() - tSql)/1000);
                    }*/
