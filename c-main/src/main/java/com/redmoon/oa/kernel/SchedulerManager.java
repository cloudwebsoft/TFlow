    ...
    public void scheduleJob(String jobId, String jobClass, String cron,
        ...
        if (isStarted()) {
            try {
                ...
                if ("com.redmoon.oa.job.WorkflowJob".equals(jobClass)) {
                ...
                } else if ("com.redmoon.oa.job.WorkplanJob".equals(jobClass)) {
                    jobDetail.getJobDataMap().put("id", dataMap);
                    ...
                    //}
                } else if ("com.redmoon.oa.fileark.robot.RobotJob".equals(jobClass)) {
                    jobDetail.getJobDataMap().put("id", dataMap);
                }
