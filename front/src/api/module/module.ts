...
const Api = {
  ...
  getQichachaList: `${setting.interfacePrefix}/qichacha/list`, //企查查list
  getQichachaDetail: `${setting.interfacePrefix}/qichacha/detail`, //企查查查看
};
...
export const getQichachaList = (params?: any) =>
  defHttp.post<any>({ url: Api.getQichachaList, params });

export const getQichachaDetail = (params?: any) =>
  defHttp.post<any>({ url: Api.getQichachaDetail, params });
