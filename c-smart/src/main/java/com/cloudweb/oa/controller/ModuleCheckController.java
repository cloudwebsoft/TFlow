...
public class ModuleCheckController {
    ...
    public String checkFieldIsUnique(@RequestParam(value="id", defaultValue="-1") long id, @RequestParam(value="formCode")String formCode, @RequestParam(value="fieldName", required = false)String fieldName) {
    ...
    public String checkFieldIsUniqueNest(@RequestParam(value="id", defaultValue="-1") long id, @RequestParam(value="formCode")String formCode, @RequestParam(value="fieldName")String fieldName, @RequestParam(value="cwsId")String cwsId, @RequestParam(value="parentFormCode")String parentFormCode) {
        JSONObject json = new JSONObject();
    ...
    public String checkEmail(@RequestParam(value = "formCode") String formCode, @RequestParam(value = "fieldName") String fieldName, @RequestParam(value = "val") String val) {
        JSONObject json = new JSONObject();
    ...
    public String checkMobile(@RequestParam(value="formCode")String formCode, @RequestParam(value="fieldName")String fieldName, @RequestParam(value="val")String val) {
        JSONObject json = new JSONObject();
    ...
    public String checkIDCard(@RequestParam(value="val")String val) {
        JSONObject json = new JSONObject();
